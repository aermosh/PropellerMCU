...
#define MASK_LMM (1 << 3)
#define MASK_P2 (1 << 4)
#define MASK_PASM (1 << 5)
#define MASK_OUTPUT_SPINCODE (1 << 6)
#define MASK_XMM (1 << 7)
#define MASK_XMM_SINGLE (1 << 8)
#define MASK_XMM_SPLIT (1 << 9)
#define MASK_XMM_CODE (1 << 10)
...
#define TARGET_P2 ((target_flags & MASK_P2) != 0)
...
enum opt_code
{
  ...
  OPT_mspin = 760,                           /* -mspin */
  OPT_mxmm = 761,                            /* -mxmm */
  OPT_mxmm_single = 762,                     /* -mxmm-single */
  OPT_mxmm_split = 763,                      /* -mxmm-split */
  OPT_mxmmc = 764,                           /* -mxmmc */
  OPT_n = 765,                               /* -n */
  OPT_no_canonical_prefixes = 766,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 767,               /* -no-integrated-cpp */
  OPT_nodefaultlibs = 768,                   /* -nodefaultlibs */
  OPT_nostartfiles = 769,                    /* -nostartfiles */
  OPT_nostdinc = 770,                        /* -nostdinc */
  OPT_nostdinc__ = 771,                      /* -nostdinc++ */
  OPT_nostdlib = 772,                        /* -nostdlib */
  OPT_o = 773,                               /* -o */
  OPT_p = 774,                               /* -p */
  OPT_pass_exit_codes = 775,                 /* -pass-exit-codes */
  OPT_pedantic = 776,                        /* -pedantic */
  OPT_pedantic_errors = 777,                 /* -pedantic-errors */
  OPT_pg = 778,                              /* -pg */
  OPT_pie = 779,                             /* -pie */
  OPT_pipe = 780,                            /* -pipe */
  OPT_print_file_name_ = 781,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 782,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 783,           /* -print-multi-directory */
  OPT_print_multi_lib = 784,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 785,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 786,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 787,                /* -print-prog-name= */
  OPT_print_search_dirs = 788,               /* -print-search-dirs */
  OPT_print_sysroot = 789,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 790,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 791,                           /* -quiet */
  OPT_r = 792,                               /* -r */
  OPT_remap = 793,                           /* -remap */
  OPT_s = 794,                               /* -s */
  OPT_save_temps = 795,                      /* -save-temps */
  OPT_save_temps_ = 796,                     /* -save-temps= */
  OPT_shared = 797,                          /* -shared */
  OPT_shared_libgcc = 798,                   /* -shared-libgcc */
  /* OPT_specs = 799, */                     /* -specs */
  OPT_specs_ = 800,                          /* -specs= */
  OPT_static = 801,                          /* -static */
  OPT_static_libgcc = 802,                   /* -static-libgcc */
  OPT_static_libgfortran = 803,              /* -static-libgfortran */
  OPT_static_libgo = 804,                    /* -static-libgo */
  OPT_static_libstdc__ = 805,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 806, */                 /* -std=c++03 */
  OPT_std_c__0x = 807,                       /* -std=c++0x */
  OPT_std_c__98 = 808,                       /* -std=c++98 */
  OPT_std_c1x = 809,                         /* -std=c1x */
  /* OPT_std_c89 = 810, */                   /* -std=c89 */
  OPT_std_c90 = 811,                         /* -std=c90 */
  OPT_std_c99 = 812,                         /* -std=c99 */
  /* OPT_std_c9x = 813, */                   /* -std=c9x */
  OPT_std_gnu__0x = 814,                     /* -std=gnu++0x */
  OPT_std_gnu__98 = 815,                     /* -std=gnu++98 */
  OPT_std_gnu1x = 816,                       /* -std=gnu1x */
  /* OPT_std_gnu89 = 817, */                 /* -std=gnu89 */
  OPT_std_gnu90 = 818,                       /* -std=gnu90 */
  OPT_std_gnu99 = 819,                       /* -std=gnu99 */
  /* OPT_std_gnu9x = 820, */                 /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 821, */          /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 822,              /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 823, */          /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 824, */          /* -std=iso9899:199x */
  OPT_symbolic = 825,                        /* -symbolic */
  OPT_t = 826,                               /* -t */
  OPT_time = 827,                            /* -time */
  OPT_time_ = 828,                           /* -time= */
  OPT_traditional = 829,                     /* -traditional */
  OPT_traditional_cpp = 830,                 /* -traditional-cpp */
  OPT_trigraphs = 831,                       /* -trigraphs */
  OPT_u = 832,                               /* -u */
  OPT_undef = 833,                           /* -undef */
  OPT_v = 834,                               /* -v */
  OPT_version = 835,                         /* -version */
  OPT_w = 836,                               /* -w */
  OPT_wrapper = 837,                         /* -wrapper */
  OPT_x = 838,                               /* -x */
  OPT_z = 839,                               /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
